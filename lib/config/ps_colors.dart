...
///
///
// static Color blackPurleColor = const  Color(0xff9292B8);
static Color categoryStartColor ;
  ...
  static Color  colorBtn = const Color(0xff9292B8);
  static Color blackPurleColor = const  Color(0xff9292B8);
  ...
  /// Light Theme
  ///
  static const Color _l_base_color = Color(0xFFF3FAFF);
  static const Color _l_base_dark_color = Color(0xFFFFFFFF);
  static const Color _l_base_light_color = Color(0xFFF3FAFF);

  static const Color _l_text_primary_color = Color(0xFF8997B5);
  static const Color _l_text_primary_light_color = Color(0xff8997b5);
  static const Color _l_text_primary_dark_color = Color(0xFF8997B5);

  static const Color _l_icon_color = Color(0xFF6C7A98);

  static const Color _l_divider_color = Color(0xFF6C7A98);
  ...
  static const Color _d_divider_color = Color(0xFF6C7A98);
  ...
  static const Color _c_main_color = Color(0xFF6242FF);
  static const Color _c_main_light_color = Color(0xFFF0F0FE); //FFF0F1);
  static const Color _c_main_dark_color = Color(0xFF9996FF);

  static const Color _c_white_color = Color(0xFFF3FAFF);
  static const Color _c_black_color = Colors.black;
  static const Color _c_grey_color = Color(0xFF8997B5);
  static const Color _c_blue_color = Colors.blue;
  static const Color _c_transparent_color = Colors.transparent;
  static const Color _c_paid_ads_color = Color(0xFF69CF5A);

  static const Color _c_facebook_login_color = Color(0xFF6242FF);
  static const Color _c_google_login_color = Color(0xFF6242FF);
  static const Color _c_phone_login_color = Color(0xFF6242FF);
  static const Color _c_apple_login_color = Color(0xFF6242FF);

  static const Color _c_paypal_color = Color(0xff6242ff);
  static const Color _c_stripe_color = Color(0xff6242ff);

  static const Color _c_rating_color = Color(0xFFF1B553);
  static const Color _c_sold_out = Color(0xFF9996FF);
  static const Color _c_item_type_color = Color(0xFF8997B5);
  ...
  static void _loadDarkColors() {
    ...
    categoryStartColor = PsColors.mainColor;
